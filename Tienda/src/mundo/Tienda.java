...
public class Tienda {
    ...
    // Atributos
    // -----------------------------------------------------------------
    private static ArrayList<Tienda> listaProductos = new ArrayList<>();
    /**
     ...
     */
    public Tienda(String pTipo, Producto pNombre, Producto pValorUnitario, Producto pCantidadBodega, Producto pCantidadMinima, Producto pRutaImagen) {
