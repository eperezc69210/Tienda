...
public class Producto {
    ...
    public void cambiarCantidadMinima(int nuevaCantidadMinima) {
         cantidadBodega=nuevaCantidadMinima;
    }
    ...
    public double darIVA() {
        ...
        switch (tipo) {
            case "supermecado":
                iva = valorUnitario * 0.04; // IVA del 4% para productos de supermercado
                break;
            case "drogueria":
                iva = valorUnitario * 0.12; // IVA del 12% para productos de drogueria
                break;
            case "papeleria":
                iva = valorUnitario * 0.16; // IVA del 16% para productos de papeleria
                break;
            default:
